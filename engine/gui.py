...
.masthead{display:flex;align-items:center;gap:14px;margin:0 0 10px}
/* Every colour in this band is one the U1 can actually print: the four loaded
   filaments and the eighteen blends of them. Hard stops rather than a smooth
   fade, because a fade would imply colours between them that do not exist. */
.band{height:8px;border-radius:5px;margin:0 0 20px;background:linear-gradient(90deg, #E99066 0.0%, #E99066 4.55%, #F2BC54 4.55%, #F2BC54 9.09%, #F9ED3D 9.09%, #F9ED3D 13.64%, #D8DF50 13.64%, #D8DF50 18.18%, #BCCC65 18.18%, #BCCC65 22.73%, #A6B681 22.73%, #A6B681 27.27%, #A9EC57 27.27%, #A9EC57 31.82%, #68E27C 31.82%, #68E27C 36.36%, #3ACEB3 36.36%, #3ACEB3 40.91%, #49A3CA 40.91%, #49A3CA 45.45%, #29A7E2 45.45%, #29A7E2 50.0%, #08ABFB 50.0%, #08ABFB 54.55%, #6C9DB7 54.55%, #6C9DB7 59.09%, #9199A4 59.09%, #9199A4 63.64%, #417CD7 63.64%, #417CD7 68.18%, #735DB9 68.18%, #735DB9 72.73%, #A747A0 72.73%, #A747A0 77.27%, #A6789D 77.27%, #A6789D 81.82%, #B95F97 81.82%, #B95F97 86.36%, #CA4A93 86.36%, #CA4A93 90.91%, #D93B90 90.91%, #D93B90 95.45%, #E3647B 95.45%, #E3647B 100.0%)}
@media (max-width:460px){.band{height:6px}}
...
<div class="band" title="the 22 colours a Snapmaker U1 can make: 4 filaments and 18 blends of them"></div>
