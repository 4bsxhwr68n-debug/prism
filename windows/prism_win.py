"""Windows entry point, bundled by PyInstaller into Prism.exe.

One binary serving three jobs, dispatched on argv:

    Prism.exe                    open the app window
    Prism.exe a.3mf b.3mf        files dropped on the icon, console journey
    Prism.exe --engine ...       internal: the engine, re-entered by the GUI
